...
# Sync client singleton (kept for backward compat until remaining files are migrated)
...
def get_supabase_client() -> Client:
    """
    Get or create a synchronous Supabase client singleton.

    Kept for backward compatibility while files are migrated to AsyncClient.
    New code should use get_async_supabase_client() instead.
    """
...
def get_async_supabase_client() -> AsyncClient:
    """
    Get or create an asynchronous Supabase client singleton.
    ...
    Returns:
        AsyncClient: The async Supabase client instance
    ...
    if _async_supabase_client is None:
        ...
        _async_supabase_client = AsyncClient(supabase_url, supabase_key)
    return _async_supabase_client


def __getattr__(name: str):
    """
    Module-level __getattr__ for lazy loading of the supabase clients.
